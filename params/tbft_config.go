...
// Config defines the top level configuration for a upschain node
...
// DefaultConfig returns a default configuration for a upschain node
...
// BaseConfig defines the base configuration for a upschain node
...
// DefaultBaseConfig returns a default base configuration for a upschain node
...
// TestBaseConfig returns a base configuration for testing a upschain node
...
// P2PConfig defines the configuration options for the upschain peer-to-peer networking layer
...
// ConsensusConfig defines the configuration for the upschain consensus service,
