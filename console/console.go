...
import (
	...
	"github.com/iceming123/ups/internal/jsre"
	"github.com/iceming123/ups/internal/web3ext"
...
// Welcome show summary of current Gups instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gups metadata
	fmt.Fprintf(c.printer, "Welcome to the Gups JavaScript console!\n\n")
	c.jsre.Run(`
