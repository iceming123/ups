...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, upschain.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*upschain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (upschain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q upschain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q upschain.FilterQuery, ch chan<- types.Log) (upschain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q upschain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg upschain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg upschain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg upschain.CallMsg) (uint64, error) {
...
func toCallArg(msg upschain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
